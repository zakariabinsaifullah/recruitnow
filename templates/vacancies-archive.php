                                ...
                                <a href="<?php the_permalink(); ?>" class="main-wrapper text-normal row p-4">
                                    ...
                                    <div class="content col-md-8">
                                        ...
                                        <span class="badge badge-secondary">
                                            <?php  
                                               echo __('Uitzenden', 'recruitnow')
                                            ?>
                                        </span>
                                        <?php
                                        $country = get_post_meta($post_id, 'recruit_now_country', true);
                                            if (!empty($country)) :
                                        ?>
                                            <span class="small text-muted">
                                                <span class="mx-2">|</span>
                                                <span class="recruit-archive-icon-wrap">
                                            ...
                                            <?php
                                            echo "<span class='archive-icon-text'>" . $country . "</span>";
                                        endif;
                                            ?>
                                            </span>
